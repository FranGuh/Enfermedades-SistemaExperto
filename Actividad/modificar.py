...
def ventana_modificacion(id_objeto):
    def cargar_datos():
        try:
            ...
            if resultado:
                ...
                messagebox.showwarning("Advertencia", "No se encontró ninguna Actividad con ese ID.")
    ...
    def realizar_modificacion():
        ...
        if nuevo_nombre:
            try:
                ...
                messagebox.showinfo("Éxito", "Actividad modificada exitosamente.")
                
                # Cerrar ventana de modificación
                ventana_modificacion.destroy()

            except Exception as e:
                messagebox.showerror("Error", f"Error al modificar la Actividad: {e}")
    ...
    tk.Label(ventana_modificacion, text="Nuevo Nombre:").pack()
    ...
    #tk.Label(ventana_modificacion, text="Nueva Descripción:").pack()
    ...
    modificar_btn = tk.Button(ventana_modificacion, text="Modificar", command=realizar_modificacion)
    modificar_btn.pack(pady=10)

    # Cargar los datos al abrir la ventana
    cargar_datos()

def ventana_ingreso_id():
        ...
        if id_objeto:
            ...
            try:
                ...
                if resultado:
                    ...
                    messagebox.showwarning("Advertencia", "No se encontró una Actividad con ese ID.")

            except Exception as e:
                messagebox.showerror("Error", f"Error al buscar la Actividad: {e}")
