...
def ventana_modificacion(id_objeto):
    ...
    ventana_modificacion.title("Sintoma")
...
def ventana_ingreso_id2():
    def obtener_id_y_modificar():
        ...
        if id_objeto:
            ...
            try:
                ...
                messagebox.showerror("Error", f"Error al buscar Sintoma: {e}")

            finally:
                db_controlador.cerrar_conexion()
        else:
            messagebox.showwarning("Advertencia", "Por favor, ingresa un ID de un Sintoma.")
    ...
    tk.Label(ventana_ingreso, text="ID del Sintoma:").pack()
